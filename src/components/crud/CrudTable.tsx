            ...
            <Table stickyHeader style={{ minWidth: 1500 }}>
              <TableHead>
                <TableRow>
                  ...
                  <TableCell sx={{ minWidth: 200 }}>Brief about the the entity / person</TableCell>
                  <TableCell sx={{ minWidth: 250 }}>Projects and Initiatives</TableCell>
                  ...
                  <TableCell sx={{ minWidth: 150 }}>Title of the program / project/ initiative</TableCell>
